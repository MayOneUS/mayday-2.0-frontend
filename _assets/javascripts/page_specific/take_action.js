if( window.location.pathname == '/take-action/' || window.location.pathname == '/june23/' || window.location.pathname == '/presidential-poll/' || window.location.pathname == '/new-presidential-poll/'){
